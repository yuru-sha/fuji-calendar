...
富士山カレンダーの天体計算エンジンの詳細について説明します。

## 概要

本システムでは**Astronomy Engine**（NASA JPL準拠）を使用して、ダイヤモンド富士とパール富士の発生時刻を高精度で計算しています。
...
**条件:**
- 太陽の方位角 = 撮影地点から富士山への方位角 ± 許容範囲
- 太陽の仰角 = 撮影地点から富士山頂への仰角 ± 許容範囲

**シーズン:** 10月〜2月（太陽の南中高度が低い時期）
...
**条件:**
- 月の方位角 = 撮影地点から富士山への方位角 ± 許容範囲
- 月の仰角 = 撮影地点から富士山頂への仰角 ± 許容範囲
- 月の出入り時刻の前後30分間
