...
# ヘルプ表示
show_help() {
    echo "ダイヤモンド富士・パール富士カレンダー Docker開発環境"
    echo ""
    echo "使用方法:"
    echo "  $0 [コマンド]"
    echo ""
...
db_shell() {
    ...
    docker-compose -f docker-compose.dev.yml exec app-dev sh -c "sqlite3 /app/data/fuji-calendar-dev.db"
}
